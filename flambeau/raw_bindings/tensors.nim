...
## Compute the 2-D Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func fft2*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_fft2(@)".}
## Compute the 2-D Fourier transform
func fft2*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_fft2(@)".}
## Compute the 2-D Fourier transform
...
## Compute the 2-D Inverse Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func ifft2*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_ifft2(@)".}
## Compute the 2-D Inverse Fourier transform
func ifft2*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_ifft2(@)".}
## Compute the 2-D Inverse Fourier transform

func fftn*(t: Tensor, s: IntArrayRef, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.
    importcpp: "torch::fft_fftn(@)".}
...
## Compute the N-D Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func fftn*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_fftn(@)".}
## Compute the N-D Fourier transform
func fftn*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_fftn(@)".}
## Compute the N-D Fourier transform

func ifftn*(t: Tensor, s: IntArrayRef, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.
    importcpp: "torch::fft_ifftn(@)".}
...
## Compute the N-D Inverse Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func ifftn*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_ifftn(@)".}
## Compute the N-D Inverse Fourier transform
func ifftn*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_ifftn(@)".}
## Compute the N-D Inverse Fourier transform
...
## Compute the N-D Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func rfft2*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_rfft2(@)".}
## Compute the N-D Fourier transform
func rfft2*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_rfft2(@)".}
## Compute the N-D Fourier transform
...
## Compute the N-D Inverse Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func irfft2*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_irfft2(@)".}
## Compute the N-D Inverse Fourier transform
func irfft2*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_irfft2(@)".}
## Compute the N-D Inverse Fourier transform
...
## Compute the N-D Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func rfftn*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_rfftn(@)".}
## Compute the N-D Fourier transform
func rfftn*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_rfftn(@)".}
## Compute the N-D Fourier transform
...
## Compute the N-D Inverse Fourier transform
## ``s`` represents signal size. If given, each dimension dim[i] will either be zero padded or trimmed to the length s[i] before computing the FFT.
func irfftn*(t: Tensor, dim: IntArrayRef, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_irfftn(@)".}
## Compute the N-D Inverse Fourier transform
func irfftn*(t: Tensor, norm: CppString = defaultNorm): Tensor {.importcpp: "torch::fft_irfftn(@)".}
## Compute the N-D Inverse Fourier transform
